...
export class caregivers1643204674447 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`create table caregiver
            (
            id                 serial
        ...
        await queryRunner.query(`create table patient_caregiver
            (
            id            serial
