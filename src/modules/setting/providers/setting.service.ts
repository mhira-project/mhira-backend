...
export class SettingService {
    ...
    async update<K extends keyof SettingDto>(settingDto: UpdateSettingInput): Promise<boolean> {
    ...
    async updateKey<K extends keyof SettingDto>(key: K, value: SettingDto[K]): Promise<boolean> {
